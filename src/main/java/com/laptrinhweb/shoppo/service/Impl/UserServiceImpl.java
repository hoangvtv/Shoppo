...
import com.laptrinhweb.shoppo.repositories.UserRepository;
import com.laptrinhweb.shoppo.service.UserService;
import com.laptrinhweb.shoppo.util.CustomerUtility;
...
public class UserServiceImpl implements UserService {
	...
	public User loadUserByUsername(String userName) {
		User user=userRepository.checkUserByEmail(userName);
		return  user;
	}
	...
	public boolean loginCustomer(String email, String password) {
		return userRepository.findValidUser(email, password);
	}
	...
	@Override
	public void sendMail(User customer) {
		try {
			if (customer != null) {
