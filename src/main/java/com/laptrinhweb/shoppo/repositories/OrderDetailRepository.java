...
public interface OrderDetailRepository extends JpaRepository<OrderDetail, Long> {
	...
	@Query("select od from OrderDetail od join Order o on od.order.id = o.id where o.id in :id and o.customerEmail =:customerEmail order by o.id desc")
	...
	@Query("select od from OrderDetail od join Order o on od.order.id = o.id where od.orderStatus= :orderStatus order by o.orderDate desc")
	...
	@Query("select od from OrderDetail od join Order o on od.order.id = o.id order by o.id desc")
	List<OrderDetail> findAllOrders();
	
	@Query(value = "select o from OrderDetail o order by o.order.id desc")
