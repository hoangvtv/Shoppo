        ...
        <c:if test="${not empty items}">
            <div class="checkout-left">
                <div class="address_form_agile mt-sm-5 mt-4">
                    <form action="${pageContext.request.contextPath}/cart/order/checkout" method="post"
                        ...
                        <div class="creditly-wrapper wthree, w3_agileits_wrapper">
                                    ...
                                    <table id="example" class="table table-hover table-bordered text-center">
                                        ...
                                        <c:forEach var="item" items="${items}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="${pageContext.request.contextPath}/product/productdetails?code=${item.product.code}"
                                                       target="_blank">
                                                        <img src="${pageContext.request.contextPath}${item.product.image}"
                                                             width="70" height="90" class="img-fluid"/></a>
                                                ...
                                                <td><a href="${pageContext.request.contextPath}/cart/remove/${item.id}"
                                                       style="font-size:35px;color:#F45C5D;"
                                            ...
                                            <input type="text" id="xx" name="pid_${count}" value="${item.product.id}"
                                                   required="required"/>
                                            <input type="text" id="xx" name="quantity_${count}" value="${item.quantity}"
                                                   required="required"/>
                                            <input type="text" id="xx" name="amount_${count}" value="${item.price}"
                                                   required="required"/>
                                            <input type="text" id="xx" name="mrp_${count}" value="${item.mrpPrice}"
                                                   required="required"/>
                                            <input type="text" id="xx" name="code_${count}" value="${item.product.code}"
                                                   required="required"/>
                                            ...
                                            <input type="text" id="xx" name="cid_${count}" value="${item.id}"
                                                   required="required"/>
                                        </c:forEach>
                                        </tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary">
                                                    Total Savings: <span
                                                        class="badge badge-light">&#x20b9;${total_saving}</span>
                                                </button>
                                            </td>
                                        </tr>
                                        </tfoot>
                            ...
                            <div class="information-wrapper"><br>
                                ...
                                <h5 class="mb-sm-4 mb-3 text-danger" style="font-weight: bold;">Note: As of now Cash on
                                    Delivery payment mode is available.</h5>
                                <div class="first-row">
                                    ...
                                    <div class="w3_agileits_card_number_grids">
                                        <div class="w3_agileits_card_number_grid_left form-group">
                                            <div class="controls">
                                                ...
                                                <input type="text" class="form-control" value="${phone}" maxlength="10"
                                                       name="customerPhone" id="txtPhone" required="required"/>
                                        ...
                                        <div class="w3_agileits_card_number_grid_right form-group">
                                            <div class="controls">
                                                ...
                                                <textarea name="address" class="form-control" rows="4" cols="45"
                                        ...
                                        <div class="w3_agileits_card_number_grid_right form-group">
                                            <div class="controls">
                                                ...
                                                <input type="text" class="form-control" value="${pinCode}" maxlength="6"
                                ...
                                <div class="col-sm-12 text-left">
                                    <input type="submit" id="submit" class="btn btn-success btn-md center-block"
                                           value="Buy" style="width: 100px;"/>
                                    &emsp;<input type="button" class="btn btn-danger reset" value="Clear"
                                                 style="width: 100px;"/>
                                </div>
                            </div>
                        </div>
