        ...
        <div class="container">
            <table id="example" class="table table-hover">
                ...
                <tr>
                    ...
                    <td><a href="${pageContext.request.contextPath}/product/productdetails?code=${code}"
                           target="_blank">
                        <img src="${pageContext.request.contextPath}${image}" width="70" height="90"
                             class="img img-responsiive"/></a>
                        <br>${itemName}</td>
                    <td>${quantity}</td>
                    <td>${price}</td>
                    <td>${totalPrice}</td>
                            ...
                            <div class="information-wrapper">
                                <div class="first-row">
                                    ...
                                    <div class="w3_agileits_card_number_grids">
                                        ...
                                        <div class="w3_agileits_card_number_grid_right form-group">
                                            <div class="controls">
                                                <label class="col-form-label"><b>Pin Code</b> [As of now product
                                                    delivery for pin code 400601 is available.]</label>
                                                <input type="text" class="form-control" value="400601" maxlength="6"
