            ...
            <div class="col-lg-6 d-none d-lg-block">
                <div class="header-navigation">
                    <ul class="main-nav justify-content-start">
                        <li class="has-submenu"><a href="${pageContext.request.contextPath}/home">home</a>
...
<%--                            </ul>--%>
                        ...
                        <li class="has-submenu position-static"><a href="${pageContext.request.contextPath}/product/all">shop</a>
            ...
            <div class="col-7 col-sm-6 col-lg-3">
                <div class="header-action justify-content-end">
                  ...
                  <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <a class="header-action-btn" href="${pageContext.request.contextPath}/customer/login">
                                <span class="icon">
                  <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
